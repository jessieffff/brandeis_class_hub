...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference("Holiday.count") do
      post holidays_url, params: { holiday: { date: @holiday.date, event_category: @holiday.event_category, event_id: @holiday.event_id, event_name: @holiday.event_name, type: @holiday.type } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { date: @holiday.date, event_category: @holiday.event_category, event_id: @holiday.event_id, event_name: @holiday.event_name, type: @holiday.type } }

...
class ClassPeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_period" do
    assert_difference("ClassPeriod.count") do
      post class_periods_url, params: { class_period: { course_id: @class_period.course_id, date_time: @class_period.date_time, datetime: @class_period.datetime, end_time: @class_period.end_time, individual_class_id: @class_period.individual_class_id, integer: @class_period.integer, start_time: @class_period.start_time } }
    end
  ...
  test "should update class_period" do
    patch class_period_url(@class_period), params: { class_period: { course_id: @class_period.course_id, date_time: @class_period.date_time, datetime: @class_period.datetime, end_time: @class_period.end_time, individual_class_id: @class_period.individual_class_id, integer: @class_period.integer, start_time: @class_period.start_time } }

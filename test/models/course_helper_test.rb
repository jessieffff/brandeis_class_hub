...
class CalendarHelperTest < ActiveSupport::TestCase
  ...
  test "generate a class" do
    ...
    correct_params = [
        {name: "COSCI_CLASS", course_id: 1, start_time: "10:00AM", end_time: "12:00PM", date: Date.new(2022, 10, 03)},
        {name: "COSCI_CLASS", course_id: 1, start_time: "10:00AM", end_time: "12:00PM", date: Date.new(2022, 10, 10)},
        {name: "COSCI_CLASS", course_id: 1, start_time: "10:00AM", end_time: "12:00PM", date: Date.new(2022, 10, 05)},
        {name: "COSCI_CLASS", course_id: 1, start_time: "10:00AM", end_time: "12:00PM", date: Date.new(2022, 10, 06)}
    ]
    for i in 0...4 do

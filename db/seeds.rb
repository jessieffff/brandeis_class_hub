...
for i in 1..10 do
  ...
  Course.create(calendar_id: i, name: Faker::Lorem.word,
                    start_date: Faker::Date.in_date_period(year: 2022, month: 9), end_date: Faker::Date.in_date_period(year: 2022, month: 12), professor_name: Faker::Name.first_name,  repetition_frequency: Faker::Types.character)
...
u = User.create(first_name: "David", last_name: "Shapiro", email: "david.shapiro@gmail.com")

...
10.times do
  User.create(full_name: Faker::Name.first_name, email: Faker::Internet.email)
end
for i in 1..10 do
  ...
  Course.create(calendar_id: i, name: Faker::Lorem.word,
                    start_date: Faker::Date.in_date_period(year: 2022, month: 9), end_date: Faker::Date.in_date_period(year: 2022, month: 12), location: Faker::Address.full_address, professor_name: Faker::Name.first_name, repetition_frequency: Faker::Types.character, url: Faker::Internet.url)
...
u = User.create(full_name: "David Shapiro", email: "david.shapiro@gmail.com")
